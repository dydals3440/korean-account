...
- 1d1d529: 검증 어댑터 패밀리 — valibot · yup · arktype · standard-schema 추가.
...
- 44f3852: 0.2.0 — 전면 재구조화. 자세한 마이그레이션은 아래 표 참고.
...
- 7f50ef5: chore: 개발/CI 툴체인 유지보수 업데이트
...
- 8c37605: README 의 거짓 예제를 고치고, 문서 주장을 테스트로 못 박습니다.
...
- 9ccce20: 0.1.0 에서 실수로 제거한 패턴 필드 4개를 되돌립니다.
